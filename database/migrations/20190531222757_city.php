...
class City extends Migrator
{
    ...
    {
        $table = $this->table('city', ['charset' => 'utf8', 'auto_incrment' => 1]);
        $table
            ->addColumn('name', 'string', ['limit' => 50, 'null' => false, 'default' => ''])
            ->addColumn('uname', 'string', ['limit' => 50, 'null' => false, 'default' => ''])
            ->addColumn('parent_id', 'integer', ['limit' => 10, 'signed' => false, 'null' => false, 'default' => 0])
            ->addColumn('is_default', 'integer', ['limit' => 10, 'signed' => false, 'null' => false, 'default' => 0])
